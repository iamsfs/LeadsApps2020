package com.ics.creditcardprocessing.webservices.impl;

import android.support.annotation.NonNull;
import android.util.Log;
import android.widget.Toast;

import com.ics.creditcardprocessing.ApplicationClass;
import com.ics.creditcardprocessing.webservices.ApiInterface;
...
public class IrsLeadsWebserviceImpl implements IrsLeadsWebservice {
    ...
    // TODO: 16/05/2020 call this api on code verification screen
    // new api integration
    private static void saveLeads(ParseObject mCCRA, ParseObject mBusinessInfo) {
        String name = mCCRA.get("Name").toString() + " " + mCCRA.get("LastName").toString();
        String source = mCCRA.getString("source");
        String dba = mBusinessInfo.getString("businessName");
        String phone = mCCRA.getString("Phone");
...
//        String note = "CCRA2020";
        ...
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                Log.e("changes", "data saved to leads rest api after code verification");
    ...
    private Map<String, RequestBody> createHashMap(ParseObject mCCRA, ParseObject mPrincipalInfo, ParseObject mBusinessInfo, ParseObject mAccountInfo, ParseObject pricingObject) {
        ...
        */
        ...
        String[] name_split = mCCRA.get("Name").toString().split(" ");
