package com.ics.creditcardprocessing.helper;
...
import com.ics.creditcardprocessing.R;
...
public class GestureOverlayView extends FrameLayout {
    ...
    //private int mCertainGestureColor = 0xFFFFFF00; // Yellow
    //private int mCertainGestureColor = 0xFF0000FF; // Blue
    private int mCertainGestureColor = 0xFF000000; // Black
    private int mUncertainGestureColor = 0x48FFFF00;
    private float mGestureStrokeWidth = 10.0f;
    ...
    private boolean mResetGesture = false;
    ...
    // fading out effect
    private boolean mIsFadingOut = true;
