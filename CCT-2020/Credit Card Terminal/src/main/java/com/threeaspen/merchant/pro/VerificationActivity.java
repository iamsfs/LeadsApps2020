...
import com.threeaspen.merchant.pro.helper.MySSLSocketFactory;
import com.threeaspen.merchant.pro.helper.ShowNotification;
import com.threeaspen.merchant.pro.utility.Utility;
...
public class VerificationActivity extends Activity {
    ...
    private EditText text_verification, text_verification2, text_verification3, text_verification4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (text_verification2 == null) {
            text_verification2 = (EditText) findViewById(R.id.text_verification2);
        }
        if (text_verification3 == null) {
            text_verification3 = (EditText) findViewById(R.id.text_verification3);
        }
        if (text_verification4 == null) {
            text_verification4 = (EditText) findViewById(R.id.text_verification4);
        }
...
//        });
        ...
        text_verification.addTextChangedListener(new TextWatcher() {
            public void afterTextChanged(Editable s) {
                if (s.toString().length() >= 1) {
                    text_verification.clearFocus();
                    text_verification2.requestFocus();
                }
            }
        ...
        text_verification2.addTextChangedListener(new TextWatcher() {
            public void afterTextChanged(Editable s) {
                if (s.toString().length() >= 1) {
                    text_verification2.clearFocus();
                    text_verification3.requestFocus();
                }
            }
        ...
        text_verification3.addTextChangedListener(new TextWatcher() {
            public void afterTextChanged(Editable s) {
                if (s.toString().length() >= 1) {
                    text_verification3.clearFocus();
                    text_verification4.requestFocus();
                }
            }
        ...
        text_verification4.addTextChangedListener(new TextWatcher() {
            public void afterTextChanged(Editable s) {
                if (s.toString().length() >= 1) {
                    text_verification4.clearFocus();
                    InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
                    imm.hideSoftInputFromWindow(text_verification4.getWindowToken(), 0);
                }
            }
    ...
    private boolean validateForm() {
        ...
        if (TextUtils.isEmpty(text_verification.getText().toString()) || TextUtils.isEmpty(text_verification2.getText().toString())
                || TextUtils.isEmpty(text_verification3.getText().toString()) || TextUtils.isEmpty(text_verification4.getText().toString())) {
            errorNotFound = false;
            ShowNotification.showErrorDialog(VerificationActivity.this, "Please enter code sent to your phone.");
        } else {
            userCode = text_verification.getText().toString() + text_verification2.getText().toString()
                    + text_verification3.getText().toString() + text_verification4.getText().toString();
            if (!TextUtils.equals(verificationCode, userCode)) {
                errorNotFound = false;
